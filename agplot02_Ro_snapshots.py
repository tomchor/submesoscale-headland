        ...
        for var in varlist:
            ...
            if zoom:
                ...
                if "yC" in snaps[var].coords: # has a y dimension
                    sel_opts = sel_opts | dict(y=slice(-snaps.L, 8*snaps.L))
            ...
            if animate:
                ...
                for y in [100, 250, 500]:
                    axes[1, 0].axhline(y=y, ls="--", lw=0.5, color="k")
                ...
                if test:
                    ...
                    if summarize:
                        outname = f"{figdir}/ag_{var}_{slice_name}_summary_facetgrid{modifier}.pdf"
                    else:
                        outname = f"{figdir}/ag_{var}_{slice_name}_facetgrid{modifier}.pdf"
